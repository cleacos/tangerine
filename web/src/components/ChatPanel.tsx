...
export function ChatPanel({
  ...
  return (
    <div className="flex h-full flex-col bg-surface">
      ...
      <div className="hidden h-14 shrink-0 items-center justify-between border-b border-edge px-5 md:flex">
        <div className="flex flex-col gap-0.5">
          <span className="text-[15px] font-bold text-fg">{taskTitle ?? "Agent"}</span>
          {branch && (
              ...
              {prUrl && (
                <>
                  ...
                  <a
                    ...
                    className="flex items-center gap-1 rounded bg-green-500/10 px-1.5 py-0.5 text-[10px] font-medium text-green-700"
                  >
                    PR
                  </a>
                </>
        ...
        <div className="flex items-center gap-1">
          {showActivityToggle && (
            <button
              ...
              className="flex items-center gap-1.5 rounded-md bg-surface-secondary px-2.5 py-1.5 text-[12px] font-medium text-fg"
            >
