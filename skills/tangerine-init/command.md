---
description: Analyze a project and generate Tangerine golden image configuration (tangerine.json + build script)
---
...
- ~/.claude/skills/tangerine-init/templates/tangerine.json — config template
